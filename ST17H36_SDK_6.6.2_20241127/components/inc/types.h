...
#define write_regb(addr,data)     (*(volatile unsigned char *)(addr)=(unsigned char)(data))
#define write_reg(addr,data)      (*(volatile unsigned int *)(addr)=(unsigned int)(data))
#define read_regb(addr)           (*(volatile unsigned char *)(addr))
...
#define HAL_WAIT_CONDITION_TIMEOUT_withValue(condition, timeout)  {\
      volatile int val = 0;\
      while(!(condition)){\
        if(val ++ > timeout)\
...
#define __ATTR_FUNC_RAM__(fn)   __attribute__(( section("._func_ram_."#fn))) fn
#define __ATTR_FUNC_OTP__(fn)   __attribute__(( section("._func_otp_."#fn))) fn
#define __ATTR_FUNC_ROM__(fn)   __attribute__(( section("._func_rom_."#fn))) fn
