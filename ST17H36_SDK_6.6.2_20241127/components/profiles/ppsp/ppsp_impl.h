...
typedef struct
{
	volatile uint16 ppsp_impl_appl_bins_pids;    // firmware/resource pids @ local flsh
    volatile uint32 ppsp_impl_appl_bins_vers;    // firmware/resource vers @ local flsh
    volatile uint16 ppsp_impl_appl_bins_rsrv;    // firmware/resource rsrv @ local flsh
    ...
    void   (*ppsp_impl_appl_start_tmo_hdlr)( uint16 tmo_int );
