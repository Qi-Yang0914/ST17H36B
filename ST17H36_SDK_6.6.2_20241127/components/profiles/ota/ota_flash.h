...
#define OTP_END_ADDR               (0x00022000)
    ...
    #define OTAF_APP_BANK_0_ADDR    0x11008000  //60K bytes
	...
	#define OTAF_APP_CUR_VERS       0x11003fd0
	#define OTAF_APP_NEW_VERS       0x11003fe0
