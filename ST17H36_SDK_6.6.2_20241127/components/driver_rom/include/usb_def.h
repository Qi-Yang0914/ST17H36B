...
#else
#define OTG_PCD_IN_FIFO_BASE                 (USB_BASE_ADDR + 0x0000UL)
#define OTG_PCD_OUT_FIFO_BASE                (USB_BASE_ADDR + 0x4000UL)
#define OTG_PCD_IN_EP_REG_BASE               (USB_BASE_ADDR + 0x4400UL)
#define OTG_PCD_OUT_EP_REG_BASE              (USB_BASE_ADDR + 0x4500UL)
#define OTG_PCD_GLB_REG_ADDR                 (USB_BASE_ADDR + 0x4600UL)
#define OTG_PCD_MAC_REG_ADDR                 (USB_BASE_ADDR + 0x4800UL)
#define OTG_HCD_GLB_REG_ADDR                 (USB_BASE_ADDR + 0x4c00UL)
#define OTG_HCD_MAC_REG_ADDR                 (USB_BASE_ADDR + 0x5000UL)
#define OTG_DIU_REG_ADDR                     (USB_BASE_ADDR + 0x5400UL)
#endif

#define OTG_TOP_REG_ADDR                     (USB_BASE_ADDR + 0x80000UL)

#define OTG_PCD_IN_EP_FIFO(__EP_NUM__)       (OTG_PCD_IN_FIFO_BASE + (__EP_NUM__)*0x400)
