...
#define LL_STATUS_ERROR_DISABLE_ADV_PENDING   		   0x3A // Controller Busy
#define LL_STATUS_ERROR_DISABLE_SCAN_PENDING   		   0x3A // Controller Busy
#define LL_STATUS_ERROR_DISABLE_INIT_PENDING   		   0x3A // Controller Busy
...
#define LL_STATUS_ENABLE_LATENCY_PENDING               0x83
 ...
 *
 */
extern void LL_SetDataLengthcmd( uint16 connId,uint16 TxOctets, uint16 TxTime , uint16 RxOctets, uint16 RxTime );
