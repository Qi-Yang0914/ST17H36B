 ...
 */
// Timers
#define TGAP_SM_TIMEOUT               0  //!< SM Message Timeout (milliseconds). Default 30 seconds.
#define TGAP_SM_MIN_KEY_LEN           1  //!< SM Minimum Key Length supported. Default 7.
#define TGAP_SM_MAX_KEY_LEN           2  //!< SM Maximum Key Length supported. Default 16.
#define TGAP_AUTH_TASK_ID             3  //!< Task ID override for Task Authentication control (for stack internal use only)
#define TGAP_PARAMID_MAX              4  //!< ID MAX-valid Parameter ID
#if 0
